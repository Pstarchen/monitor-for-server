...
const commands: Record<InstallMode, string> = {
  ...
  'https://gitee.com/starchen520/monitor-for-server/raw/v1.20.20/deploy/xingchen.sh' -o xingchen.sh &&
sudo bash xingchen.sh install --source gitee --version v1.20.20`,
  windows: `git clone --depth 1 --branch v1.20.20 https://github.com/Pstarchen/monitor-for-server.git xingchen-monitor
    ...
    <section class="home-section install-section" aria-labelledby="install-title">
      <div class="home-shell install-layout">
        <div class="install-console reveal-item" data-reveal="left">
          ...
          <div class="console-status"><span><i /> v1.20.20</span><span>PORT 18080</span></div>
