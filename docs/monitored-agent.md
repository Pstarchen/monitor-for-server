...
bash ./deploy/install-agent.sh --network-mode internal --version v1.20.18
```
...
bash ./deploy/install-agent.sh --offline --binary /srv/xingchen/xingchen-agent --version v1.20.18 --no-auto-update
```
