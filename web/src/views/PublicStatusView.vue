  ...
  <main class="public-status-page">
    ...
    <div class="public-status-content">
      ...
      <template v-else-if="overview">
        <section class="public-status-intro"><div><p class="eyebrow">LIVE INFRASTRUCTURE STATUS</p><h1>{{ overview.siteName }}</h1><p>公开展示服务器在线状态、资源负载与服务可用性。</p></div><div class="public-status-updated"><Clock3 :size="15" />更新于 {{ relativeTime(overview.generatedAt) }}</div></section>
