...
function openCreate() {
  Object.assign(form, { deviceId: deviceFilter.value || devices.value[0]?.id || '', command: '', args: '', timeoutSeconds: 30, maxOutputBytes: 65536 })
  dialog.value = true
}
