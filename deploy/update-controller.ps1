...
try {
    ...
    $imageDefaults = @(
        'ghcr.io/pstarchen/monitor-for-server-setup:v1.20.22',
        'ghcr.io/pstarchen/monitor-for-server-server:v1.20.22',
        'ghcr.io/pstarchen/monitor-for-server-web:v1.20.22'
    )
