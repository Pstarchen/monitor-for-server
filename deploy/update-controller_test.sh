...
: > "${log_file}"
run_update --check
grep -F 'docker pull ghcr.io/pstarchen/monitor-for-server-server:v1.20.14' "${log_file}" >/dev/null
grep -F 'timeout 180s docker pull ghcr.io/pstarchen/monitor-for-server-server:v1.20.14' "${log_file}" >/dev/null
...
grep -F 'timeout 7s docker pull registry.internal.example/pstarchen/monitor-for-server-server:v1.20.14' "${log_file}" >/dev/null
grep -F 'timeout 11s docker pull ghcr.io/pstarchen/monitor-for-server-server:v1.20.14' "${log_file}" >/dev/null
...
grep -E 'docker tag xingchen-controller-source-[^ ]+-1:candidate ghcr.io/pstarchen/monitor-for-server-server:v1.20.14' "${log_file}" >/dev/null
...
grep -F 'docker pull ghcr.io/pstarchen/monitor-for-server-web:v1.20.14' "${log_file}" >/dev/null
...
grep -F 'docker tag sha256:old-image ghcr.io/pstarchen/monitor-for-server-server:v1.20.14' "${log_file}" >/dev/null
